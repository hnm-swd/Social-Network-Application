...
public class EditProfileActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        birthDateEditText.setOnTouchListener((v, event) -> {
            if (event.getAction() == MotionEvent.ACTION_UP) {
                showDatePickerDialog();  // Hiển thị DatePickerDialog khi người dùng nhấn vào EditText
                return true;
            }
            return false;
        });
        ...
        doneTextView.setOnClickListener(v -> {
            ...
            // Lưu thông tin đã chỉnh sửa, nếu trường nào trống thì sẽ xóa thông tin trong SharedPreferences
    ...
    private void showDatePickerDialog() {
        // Lấy ngày hiện tại để thiết lập DatePickerDialog
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(
                ...
                (view, selectedYear, selectedMonth, selectedDay) -> {
                    // Định dạng ngày đã chọn và hiển thị vào EditText
